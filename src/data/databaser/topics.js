export const topics = [
  ...
  },
  {
    ...
    keyPoints: [
      ...
      "Kedjade svaga entiteter: en svag entitets kompletta identitet är ägarens KOMPLETTA identitet plus den partiella identifieraren, och är ägaren själv svag ingår även dess ägare — Resa identifieras av {rederiNo, fartygsnamn, avgångsdatum}. Tentans 'identifieras endast av kombinationen av 1. …, 2. samt …, 3. samt …' räknar leden; ett påstående som räknar upp nästan hela kedjan är falskt."
    ],
    pitfalls: [
  ...
  },
  {
    ...
    keyPoints: [
      ...
      "När rätt svar är att inte göra något: en relation där beroendena bildar en cykel (A → B → C → D → A) har fyra enkla kandidatnycklar, och D → {E, F} är då ett beroende av en kandidatnyckel, inte transitivt — R är i 3NF, ingen nedbrytning, ingen motivering krävs. Räkna fram alla kandidatnycklar innan du letar transitiva beroenden."
    ],
    pitfalls: [
      ...
      "Kandidatnycklar och primärattribut byter betydelse när relationen byter — 'är C primärattribut i R i schema 3?' och 'är A en kandidatnyckel i R i schema 3?' avgörs av delrelationens nycklar, inte av R:s. Ett attribut i en sammansatt nyckel är primärattribut men ingen kandidatnyckel.",
