...
export const questions = [
  { id: "str-q01", topic: "grunder", difficulty: 1,
    ...
    options: [
      ...
      { text: "Avsiktlig påverkan på en verksamhet och dess befattningshavare mot vissa ekonomiska mål.", explain: "Definitionen rymmer avsiktligheten, både verksamhet och människor, samt ekonomiska mål i vid mening." },
  ...
  { id: "str-q02", topic: "grunder", difficulty: 1,
    ...
    options: [
      { text: "Formella styrmedel, organisationsstruktur och mindre formaliserad styrning.", explain: "De tre kategorierna rymmer tekniker, struktur respektive kultur och lärande." },
  ...
  { id: "str-q03", topic: "grunder", difficulty: 2,
    ...
    options: [
      ...
      { text: "Företaget ses som processer och aktiviteter som tillsammans skapar värde för kunden.", explain: "Värdekedjeperspektivet utgår från kunden och kräver samordning mellan leden." },
  ...
  { id: "str-q04", topic: "grunder", difficulty: 2,
    ...
    options: [
      ...
      { text: "Det interna fokuset kompletteras med externt fokus på konkurrenter och kunder.", explain: "Konkurrenters kostnader och kunders betalningsvilja analyseras, och styrningen anpassas till strategin." }
    ],
  ...
  { id: "str-q05", topic: "vision", difficulty: 1,
    ...
    options: [
      { text: "Visionen anger önskad framtida riktning, affärsidén vad företaget gör och tjänar pengar på.", explain: "Visionen är ett önskvärt framtida tillstånd, affärsidén beskriver verksamheten och intäkterna." },
  ...
  { id: "str-q06", topic: "vision", difficulty: 2,
    ...
    options: [
      ...
      { text: "Legitimerande, ambition och fokus, samt identifikation och motivation.", explain: "Visionen ger samhälleligt berättigande, ramar för affärsidén, och engagemang internt." },
  ...
  { id: "str-q07", topic: "vision", difficulty: 1,
    ...
    options: [
      ...
      { text: "Att klargöra hur affärsidén ska uppnås, alltså hur företaget avser att arbeta.", explain: "Strategin är planen för att förverkliga affärsidén, med konkurrensfördelar och resurser." }
    ],
    correct: 3, source: "AJK kap 1", reviewed: true },
  ...
  { id: "str-q08", topic: "vision", difficulty: 2,
    ...
    options: [
      ...
      { text: "Vision, affärsidé, strategi, verksamhetsplanering, ekonomistyrning.", explain: "Visionen ramar in affärsidén, strategin anger vägen, planeringen bryter ned målen." },
  ...
  { id: "str-q09", topic: "mal", difficulty: 1,
    ...
    options: [
      { text: "Företag saknar den fullständiga information om framtiden som maximering förutsätter.", explain: "Beslut fattas under osäkerhet, och flera mål kan gälla beroende på sammanhang." },
  ...
  { id: "str-q10", topic: "mal", difficulty: 2,
    ...
    options: [
      ...
      { text: "Företaget strävar efter en tillfredsställande vinst i förhållande till en anspråksnivå.", explain: "Begränsad rationalitet gör maximering omöjlig, så man nöjer sig med ett minimikrav." },
  ...
  { id: "str-q11", topic: "mal", difficulty: 2,
    ...
    options: [
      { text: "Företaget söker jämvikt genom balans mellan intressenternas bidrag och belöningar.", explain: "Modellen bygger på det öppna systemsynsättet och en kompromiss mellan kraven." },
  ...
  { id: "str-q12", topic: "mal", difficulty: 2,
    ...
    options: [
      ...
      { text: "Att maximera nuvärdet av företagets samtliga framtida nettokassaflöden.", explain: "In- minus utbetalningar diskonteras med en kalkylränta, ur ett aktieägarperspektiv." },
  ...
  { id: "str-q13", topic: "mal", difficulty: 3,
    ...
    options: [
      ...
      { text: "Företaget maximerar försäljningen vid en för ägarna tillfredsställande vinstnivå.", explain: "Tillväxt antas ge ledningen högre lön, större inflytande och högre status." }
    ],
    correct: 3, source: "AJK kap 1", reviewed: true },
  ...
  { id: "str-q14", topic: "effektivitet", difficulty: 1,
    ...
    options: [
      { text: "Som graden av måluppfyllelse, uttryckt som värdet av utflödet i relation till inflödet.", explain: "Effektiviteten mäts mot ett mål, vilket gör att målnivån påverkar utfallet." },
  ...
  { id: "str-q15", topic: "effektivitet", difficulty: 1,
    ...
    options: [
      ...
      { text: "Hög produktivitet, kostnadseffektivitet och väl utvecklade rutiner och system.", explain: "Inre effektivitet är resurshushållning internt, alltså att göra saker rätt." },
  ...
  { id: "str-q16", topic: "effektivitet", difficulty: 2,
    ...
    options: [
      ...
      { text: "Att den yttre effektiviteten är låg, eftersom erbjudandet inte skapar tillräckligt kundvärde.", explain: "Företaget gör saker rätt men inte rätt saker sett ur kundens perspektiv." }
    ],
  ...
  { id: "str-q17", topic: "effektivitet", difficulty: 2,
    ...
    options: [
      { text: "Lönsamheten relaterar utfallet till det kapital som verksamheten har tagit i anspråk.", explain: "Som relationstal gör lönsamheten företag av olika storlek jämförbara." },
  ...
  { id: "str-q18", topic: "effektivitet", difficulty: 3,
    ...
    options: [
      ...
      { text: "Inbetalning och utbetalning, eftersom de avser själva betalningstransaktionerna.", explain: "Betalning kan ske både i efterskott vid kredit och i förskott vid abonnemang." },
  ...
  { id: "str-q19", topic: "organisation", difficulty: 1,
    ...
    options: [
      ...
      { text: "Verksamheten delas in efter funktioner som marknadsföring, produktion och ekonomi.", explain: "Indelningen samlar specialistkompetens inom varje funktionsområde." },
  ...
  { id: "str-q21", topic: "organisation", difficulty: 2,
    ...
    options: [
      ...
      { text: "Påverkbarhetsprincipen och befogenhetsprincipen vid utformning av ansvar.", explain: "Man ska kunna påverka det man ansvarar för och ha befogenhet att göra det." },
  ...
  { id: "str-q22", topic: "organisation", difficulty: 3,
    ...
    options: [
      ...
      { text: "Resultatansvar, eftersom det omfattar intäkter minus kostnader men inte kapitalet.", explain: "Utan kapitalpåverkan vore ett räntabilitetskrav oförenligt med påverkbarhetsprincipen." }
    ],
  ...
  { id: "str-q23", topic: "strategiutveckling", difficulty: 1,
    ...
    options: [
      { text: "Eftersom omvärlden ofta är osäker och föränderlig växer delar av strategin fram längs vägen.", explain: "Realiserad strategi är summan av avsiktlig och framväxande strategi." },
  ...
  { id: "str-q24", topic: "strategiutveckling", difficulty: 2,
    ...
    options: [
      ...
      { text: "Omvärld och positionering, därefter resurser och kärnkompetenser, därefter kunskap.", explain: "Porters branschanalys blev dominant design, sedan kom RBV, nu lärande och innovation." },
  ...
  { id: "str-q25", topic: "strategiutveckling", difficulty: 2,
    ...
    options: [
      ...
      { text: "En organisation där erfarenheter sprids och omsätts i ständig förnyelse och förbättring.", explain: "Individers lärande blir organisatoriskt när kunskapen sprids och tillämpas." },
  ...
  { id: "str-q26", topic: "strategiutveckling", difficulty: 3,
    ...
    options: [
      ...
      { text: "Dubbelkretslärande ifrågasätter även orsaken bakom problemet, inte bara problemet självt.", explain: "Enkelkrets botar symptomen, dubbelkrets tar sig även an sjukdomen." },
  ...
  { id: "str-q27", topic: "porter", difficulty: 1,
    ...
    options: [
      ...
      { text: "Lagar och regleringar som påverkar villkoren för branschens aktörer.", explain: "Reglering ingår inte som egen kraft utan fångas i bredare analyser som PESTEL." },
  ...
  { id: "str-q28", topic: "porter", difficulty: 1,
    ...
    options: [
      ...
      { text: "När företaget vill bedöma attraktiviteten i en bransch inför ett inträde.", explain: "Modellen bedömer branschens lönsamhetspotential och konkurrensintensitet." },
  ...
  { id: "str-q29", topic: "porter", difficulty: 2,
    ...
    options: [
      { text: "Kostnadsledarskap, differentiering samt fokus på ett avgränsat segment.", explain: "Konkurrensfördel nås genom lägst kostnad, unikt erbjudande eller smal inriktning." },
  ...
  { id: "str-q30", topic: "rbv", difficulty: 1,
    ...
    options: [
      { text: "De ska vara värdefulla, sällsynta och svåra för konkurrenterna att imitera.", explain: "Dessutom måste företaget vara organiserat så att resurserna kan utnyttjas." },
  ...
  { id: "str-q31", topic: "rbv", difficulty: 2,
    ...
    options: [
      ...
      { text: "Tekniken blir tillgänglig för alla konkurrenter, så vinsterna konkurreras snabbt bort.", explain: "Liknande algoritmer på liknande data ger liknande resultat hos alla aktörer." },
  ...
  { id: "str-q32", topic: "rbv", difficulty: 2,
    ...
    options: [
      ...
      { text: "Genom att tillämpa tekniken på resurser som redan är värdefulla och svårimiterade.", explain: "Insikterna blir då användbara främst för den som äger tillgångarna, som i Amazons fall." }
    ],
  ...
  { id: "str-q33", topic: "rbv", difficulty: 3,
    ...
    options: [
      { text: "Konkurrenterna har ofta funktionellt likvärdig data med mycket likartade mönster.", explain: "Dessutom kan strategin härledas ur synliga resultat och dataset läcker i praktiken." },
  ...
  { id: "str-q34", topic: "rbv", difficulty: 3,
    ...
    options: [
      ...
      { text: "Pionjärens strategiska val absorberas i den data som konkurrenternas AI analyserar.", explain: "Sena aktörer drar nytta av både egna och pionjärens tidigare ansträngningar." },
  ...
  { id: "str-q35", topic: "bsc", difficulty: 1,
    ...
    options: [
      ...
      { text: "De är historiska och visar vad som hänt utan att ange hur prestationen kan förbättras.", explain: "Därför behövs kompletterande mått som pekar framåt mot kommande perioder." },
  ...
  { id: "str-q36", topic: "bsc", difficulty: 1,
    ...
    options: [
      ...
      { text: "Finansiellt, kund, interna processer samt innovation och lärande.", explain: "Tillsammans balanserar de externa och interna mått och kopplar dem till strategin." }
    ],
  ...
  { id: "str-q37", topic: "bsc", difficulty: 2,
    ...
    options: [
      { text: "Styrkortet integrerar finansiella och icke-finansiella mått till en samlad bild.", explain: "Balansen mellan utfallsmått och drivande mått kopplar styrningen till strategin." },
  ...
  { id: "str-q38", topic: "bsc", difficulty: 3,
    ...
    options: [
      ...
      { text: "Att en utomstående ska kunna utläsa affärsenhetens konkurrensstrategi ur måtten.", explain: "Av de femton till tjugo måtten ska strategin gå att läsa av utifrån." },
  ...
  { id: "str-q39", topic: "matt", difficulty: 2,
    ...
    options: [
      ...
      { text: "De väljer mått utan att ha en kausalmodell som kopplar dem till finansiella utfall.", explain: "Utan orsak-verkan-kedja går det inte att välja de få rätta måtten bland hundratals." },
  ...
  { id: "str-q40", topic: "matt", difficulty: 2,
    ...
    options: [
      ...
      { text: "Att sätta prestationsmål på nivåer som kostar mer än de kan ge tillbaka.", explain: "Marginalnyttan av de sista procenten var noll, vilket gör målet olönsamt." },
  ...
  { id: "str-q41", topic: "matt", difficulty: 3,
    ...
    options: [
      { text: "De uppvisade signifikant högre avkastning på tillgångar och eget kapital.", explain: "Fyndet gällde över en femårsperiod jämfört med företag utan sådana modeller." },
  ...
  { id: "str-q42", topic: "tbl", difficulty: 1,
    ...
    options: [
      ...
      { text: "People, som omfattar anställda, kunder och samhället runt organisationen.", explain: "People är den sociala dimensionen av de tre i Elkingtons ramverk." },
  ...
  { id: "str-q43", topic: "tbl", difficulty: 1,
    ...
    options: [
      { text: "Att balansera resultatet inom socialt ansvar, miljö och ekonomisk framgång.", explain: "Tre resultatdimensioner gör hållbarhet mätbar och synliggör målkonflikter." },
  ...
  { id: "str-q44", topic: "tbl", difficulty: 2,
    ...
    options: [
      ...
      { text: "Införa en policy för lika löner mellan könen och utbildning av anställda.", explain: "Jämställdhet, arbetsvillkor och kompetensutveckling är sociala frågor under S." }
    ],
  ...
  { id: "str-q45", topic: "tbl", difficulty: 2,
    ...
    options: [
      ...
      { text: "Utveckling som möter dagens behov utan att äventyra kommande generationers.", explain: "Definitionen betonar globalt ansvar, social rättvisa och långsiktighet." },
  ...
  { id: "str-q46", topic: "it", difficulty: 1,
    ...
    options: [
      { text: "Affärsstrategi, IT-strategi, organisationsinfrastruktur och IT-infrastruktur.", explain: "Modellen arbetar med strategisk passform och funktionell integration." },
  ...
  { id: "str-q47", topic: "it", difficulty: 2,
    ...
    options: [
      ...
      { text: "Att omorganisera arbetsflöden och processer så att tekniken faktiskt utnyttjas.", explain: "Vinsterna realiseras först med komplementära organisatoriska förändringar." },
  ...
  { id: "str-q48", topic: "it", difficulty: 2,
    ...
    options: [
      ...
      { text: "Tekniken kan köpas och kopieras, medan kombinationen med processer inte kan.", explain: "Fördelen ligger i komplementära, svårimiterade organisatoriska resurser." }
    ],
  ...
  { id: "str-q49", topic: "it", difficulty: 3,
    ...
    options: [
      { text: "Eftersom både strategi, teknik och omvärld förändras och samspelet måste underhållas.", explain: "Ett läge som var i samklang i fjol kan vara i otakt redan nästa år." },
  ...
  { id: "str-q50", topic: "mal", difficulty: 1,
    ...
    options: [
      ...
      { text: "Som en svart låda som omvandlar resurser", explain: "Inflöde omvandlas till utflöde; hur det sker bortses från." },
  ...
  { id: "str-q51", topic: "mal", difficulty: 1,
    ...
    options: [
      { text: "Att maximera företagets vinst", explain: "Vinsten är det enda målet och enda måttet på effektivitet." },
  ...
  { id: "str-q52", topic: "mal", difficulty: 1,
    ...
    options: [
      ...
      { text: "Satisfieringsmodellen", explain: "Simon: begränsad rationalitet ger en anspråksnivå i stället för maximum." }
    ],
  ...
  { id: "str-q53", topic: "mal", difficulty: 1,
    ...
    options: [
      ...
      { text: "Att balansera intressenters krav", explain: "Målet är en kompromiss som ger långsiktig stabilitet." },
  ...
  { id: "str-q54", topic: "it", difficulty: 1,
    ...
    options: [
      ...
      { text: "Anpassning av processer och organisation tar tid", explain: "Vinsten kommer först när arbetssätten ändras." },
  ...
  { id: "str-q57", topic: "digital", difficulty: 2,
    ...
    options: [
      ...
      { text: "Egenutvecklade applikationer som hanterade en process i taget, var för sig.", explain: "Lön, redovisning, lager — varje system för sig, hos storföretag och myndigheter." },
  ...
  { id: "str-q58", topic: "digital", difficulty: 2,
    ...
    options: [
      { text: "Att företagen leddes av en generation som inte såg IT som en strategisk fråga.", explain: "IT hamnade i en silo utan koppling till kärnaffären." },
  ...
  { id: "str-q59", topic: "digital", difficulty: 2,
    ...
    options: [
      ...
      { text: "Robert Solow, som sammanfattade produktivitetsparadoxen i en mening.", explain: "Citatet är föreläsningens illustration av paradoxen." },
  ...
  { id: "str-q60", topic: "digital", difficulty: 2,
    ...
    options: [
      ...
      { text: "Kärnkompetens, strategic alignment och IT governance.", explain: "IT kopplades till affärsstrategin genom dessa tre." },
  ...
  { id: "str-q61", topic: "digital", difficulty: 2,
    ...
    options: [
      ...
      { text: "Att CIO-rollen legitimerades och Enterprise Architecture etablerades som disciplin.", explain: "Dessutom IT governance, COTS och strategic alignment som centralt koncept." },
  ...
  { id: "str-q62", topic: "digital", difficulty: 3,
    ...
    options: [
      { text: "Data pipeline, algorithm development, experimentation platform, IT infrastructure.", explain: "Tillsammans gör de beslutsfattande till en industriell process." },
  ...
  { id: "str-q63", topic: "digital", difficulty: 2,
    ...
    options: [
      ...
      { text: "Regelefterlevnad, intrångsskydd och dataintegritet via en gemensam sanning.", explain: "Defense minimerar datarisk; SSoT är dess grund." }
    ],
  ...
  { id: "str-q64", topic: "digital", difficulty: 3,
    ...
    options: [
      ...
      { text: "Sjukvård, rättsväsende och socialtjänst, där felaktig data får allvarliga följder.", explain: "Här dominerar data defense." },
  ...
  { id: "str-q65", topic: "mal", difficulty: 3,
    ...
    options: [
      { text: "Varför företag existerar och var gränsen mellan företag och marknad dras.", explain: "Marknadens transaktionskostnader gör intern samordning effektivare — till en gräns." },
  ...
  { id: "str-q66", topic: "digital", difficulty: 3,
    ...
    options: [
      ...
      { text: "Att varje ny teknikepok lägger ett lager ovanpå de tidigare, som ligger kvar.", explain: "Spagetti, ERP, SOA, moln, AI — inget försvinner, allt ska integreras." },
