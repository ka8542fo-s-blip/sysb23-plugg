...
// compact: lägre segment för verktygsrader.
export default function SegmentedControl({ segments, value, onChange, label, compact = false }) {
  return (
    <div
      role="tablist"
      aria-label={label}
      ...
      {segments.map((segment) => {
        ...
        return (
          <button
            ...
            className={`flex-1 rounded-md transition-colors duration-150 ${compact ? "px-3 py-1 text-sm" : "px-3 py-2 text-[15px]"} ${
              active
